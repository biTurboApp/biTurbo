...
{"name":"review_memory_candidate","description":"Approve, edit-and-approve, reject, merge, or defer a candidate using optimistic versioning.","inputSchema":{"type":"object","required":["candidate_id","action","expected_version"],"properties":{"candidate_id":{"type":"string"},"action":{"type":"string","enum":["approve","edit_and_approve","reject","merge","defer"]},"edited_content":{"type":"string"},"target_memory_id":{"type":"string"},"expected_version":{"type":"number"},"decided_by":{"type":"string"}}}},

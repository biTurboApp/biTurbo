...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::submit_observation,
            commands::list_observation_sources,
            commands::configure_observation_source,
            commands::source_status,
            commands::start_source_sync,
            commands::list_memory_candidates,
            commands::get_memory_candidate,
            commands::review_memory_candidate,
            commands::get_capture_policy,
            commands::update_capture_policy,
            commands::health_report,
            commands::start_integrity_check,
            commands::integrity_report,
